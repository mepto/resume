...
var bio = {
  ...
  "contacts": {
    "mobile": "060606060",
    "email": "natg.inf@gmail.com",
    "github": "mepto",
    "linkedin": "nathalie",
    "location": "Schiltigheim"
  },
  "welcomeMessage": "Hi, my name is Nathalie",
  "skills": ["Bilingual", "solid writing skills", "Good bridge between business and users"],
  ...
  "display": function () {
    ...
    if (education.onlineCourses.length > 0) {
      ...
      for (var onlineCourse in education.onlineCourses) {
        ...
        var formatOnlineCourses = HTMLonlineTitle
          .replace("%data%", education.onlineCourses[onlineCourse].title)
          .replace("#", education.onlineCourses[onlineCourse].url)
  ...
  "jobs": [
    {
      ...
      "dates": "2011-present",
      "description": "lorem ipsum lorem ipsum lorem ipsumlorem"
  ...
  "display": function () {
    if (work.jobs.length > 0) {
      ...
      for(var job in work.jobs) {
        ...
        var formatJob = HTMLworkEmployer.replace("%data%", work.jobs[job].employer)
  ...
  "display": function () {
    if (projects.projects.length > 0) {
      for (var project in projects.projects) {
        ...
        var formatProject = HTMLprojectTitle.replace("%data%", projects.projects[project].title)
